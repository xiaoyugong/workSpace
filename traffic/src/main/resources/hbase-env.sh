...
export HBASE_MASTER_OPTS="$HBASE_MASTER_OPTS -Xmx20480m $JDK_DEPENDED_OPTS"
export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS -Xmn1024m -XX:CMSInitiatingOccupancyFraction=70  -Xms12288m -Xmx12288m $JDK_DEPENDED_OPTS"
