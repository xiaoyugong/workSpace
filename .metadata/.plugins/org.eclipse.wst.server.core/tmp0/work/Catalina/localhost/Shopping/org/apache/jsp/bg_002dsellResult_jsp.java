 ...
 * Generated at: 2016-06-30 03:02:48 UTC
...
public final class bg_002dsellResult_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(session.getAttribute("form")!=null||session.getAttribute("id")!=null){
      out.write("\r\n");
      out.write("              <div align=\"center\"><a href=\"#\" onClick=\"window.open('goodsAction.do?action=16&id=");
      out.print(form.getId());
      out.write("','','width=500,height=200');\">查看详细内容</a>\r\n");
      out.write("                  ");
}else{
      out.write("\r\n");
      out.write("        登录后才能购买 </div>\r\n");
      out.write("              ");
}
      out.write("\r\n");
      out.write("            </td>\r\n");
