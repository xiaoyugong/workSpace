...
<table width="778" border="0" align="center" cellspacing="0" cellpadding="0">
 ...
 <table width="100%" height="265"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="top"><html:button property="button" styleClass="btn_grey" value="开始考试" onclick="window.opener=null;window.close();window.open('manage/startExam.do?action=startExam','','width=786,height=600,scrollbars=1');"/>	
