...
//		this.runState="--";
//	}
	public JobInfo(String jobname,long startTime){
		this.jobId="--";
	...
	public JobInfo(String jobName,float map,float red,String runState,String jobstartTime,String jobfinishTime){
		this.jobName=jobName;
		this.mapProgress=map;
		this.redProgress=red;
		this.runState=runState;
