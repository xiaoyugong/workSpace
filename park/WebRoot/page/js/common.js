$(document).ready(function(){
	...
	if(document.getElementById("tab")){
		...
		if(tabinpy){
		tabinpy.onclick=function(){
			if(tabinpy.checked==true){
				for(var i=1; i<tabinp.length; i++){
					tabinp[i].parentNode.parentNode.style.background="#f6fdea";
					tabinp[i].checked=true;
				}
			}
			else{
				for(var i=1; i<tabinp.length; i++){
				tabinp[i].parentNode.parentNode.style.background="#fff";
