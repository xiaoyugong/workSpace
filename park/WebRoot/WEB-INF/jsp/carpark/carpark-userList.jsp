...
var host = '<%=path%>/';
	...
	<div class="content-right">
		<div class="zsy-right">
			<div class="z-r-bt">
				<div class="z-r-b-l"><i>位置：</i><a href="###">停车场管理</a> » <a href="###">用户新增停车场</a></div>
				<div class="z-r-b-r"><%=date %></div>
			</div>
			<form action="<%=path %>/carpark_userList" method="post" id="searchForm">
			...
			<div class="listbox">
				<div class="listbt">
				    <form action="<%=path %>/carpark_userList" method="post" >
				    	<div class="l-b-b">名称：
					...
					<table width="100%" class="tab2" id="tab">
			            <tbody width="100%">
		            		...
		            		<tr class="">
			            		...
			            		<td>
			            			<long_date:long_date datelong="${c.posttime}"></long_date:long_date>
			            		</td>
			            		<td class="">
			            			<sec:authorize ifAnyGranted="carpark_edit">
			            			<a href="<%=path %>/carpark_userEdit?id=${c.carparkid}&method=preEdit">编辑</a> | 
			            			</sec:authorize>
			            			<sec:authorize ifAnyGranted="carpark_delete">
			            			<a href="javascript:void(0);" onclick="bulkDelete(${c.carparkid});">删除</a> | 
			            			</sec:authorize>
			            			<s:if test="username!=null">
				            			<a href="<%=path %>/carpark_toNotify?carpark.username=${username}" >发送通知</a>|
			            			</s:if>
