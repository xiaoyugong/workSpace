			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="carpark_add" method="post" id="addForm" enctype="multipart/form-data"  autocomplete="off" 
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
							<input type="hidden" name="method" value="add"/>
							<input type="hidden" name="carpark.isAuthentication" value="0"/>
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            <td align="right" width="110px">名称： </td>
						            <td align="left">
						            	<input type="text" class="mes_form1" id="name" name="carpark.name" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="address" name="carpark.address" />
						            </td>
					            </tr>
					            <tr>
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" data-rule="integer; " name="carpark.totalBerth"  />
						            </td>
					            </tr>
					        	<tr>
						            <td align="right" width="110px">停车场类别： </td>
						            <td align="left">
						           		<s:select list="carparkCategories" listKey="categoryid" listValue="name" data-rule="停车场类别:required; "
					        	...
					        	<tr>
						            ...
						            <td align="left">
						           		...
						           		headerKey="" headerValue="--请选择--" theme="simple" name="carpark.isAllowed"></s:select>
						            </td>
					            </tr>
					        	<tr>
						            <td align="right" width="110px">首停时间(分钟)： </td>
						            <td align="left">
						            	<input type="text" class="mes_form1" id="beforeMins" name="carpark.beforeMins" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="beforePrice" name="carpark.beforePrice" 
						            	 	data-rule="range[0~]"/>
						            </td>
					            </tr>
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="afterMins" name="carpark.afterMins" 
						            	 	data-rule="integer; range[0~]"/>
						            </td>
					            </tr>
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="afterPrice" name="carpark.afterPrice" 
						            	 	data-rule="range[0~]"/>
						            </td>
					            </tr>
					            <tr>
						            ...
						            <td align="left">
						            	<textarea name="carpark.feeRates" style="width: 270px; height: 100px" id="feeRates"></textarea>
						            </td>
					            </tr>
					        	<tr>
						            <td align="right" width="110px">地图类型： </td>
						            <td align="left">
						            	<s:select list="#{'1':'微地图','2':'精确入口','3':'其他'}" listKey="key" listValue="value" data-rule="地图类型:required; "
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="showLevel" name="carpark.showLevel" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="longitude" name="carpark.longitude" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="latitude" name="carpark.latitude" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="leftBottomLon" name="carpark.leftBottomLon" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="leftBottomLat" name="carpark.leftBottomLat" 
						            	 	data-rule="range[-180~180]"/>
						            </td>
					            </tr>
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="rightTopLon" name="carpark.rightTopLon" 
						            	 	data-rule="range[-180~180]"/>
						            </td>
					            </tr>
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="rightTopLat" name="carpark.rightTopLat" 
						            	 	data-rule="range[-180~180]"/>
						            </td>
					            </tr>
					        </table>
...
new PCAS("carpark.province","carpark.city","carpark.county","四川省","成都市","");
