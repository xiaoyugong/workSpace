			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="carpark_exesql" method="post" id="addForm" autocomplete="off" enctype="multipart/form-data"
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}" >
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            <td align="right" width="110px">SQL文件： </td>
						            <td align="left">
						            	<input type="file" class="mes_form1" id="upload" name="upload" 
						            	 	data-rule="SQl文件:required; "/>
						            </td>
