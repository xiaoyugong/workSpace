...
<body>
			<div class="fbbox">
				...
				<div class="fb-nr">
					...
					<form action="groundlock_bindUser" method="post" id="addForm" autocomplete="off" 
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
							<input type="hidden" name="mac" value="${mac}" id="mac"/>
							<input type="hidden" name="method" value="edit" />
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            <td align="right" width="110px">用户手机号： </td>
						            <td align="left">
						            	<input type="text" class="mes_form1" id="telephone" name="telephone" value="${telephone}" data-rule="用户手机号:required;mobile;"/>
						            </td>
					            </tr>
					        </table>
							<div class="tijiao">
