...
var host='<%=path%>';
	function importexcel(){
	 $("#addForm").form('submit',{
		 	url:host+"/carparkFloor_importExcel",
		 	onSubmit:function(){
			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="carparkFloor_importExcel" method="post" id="addForm" autocomplete="off" enctype="multipart/form-data"
					        ...
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            ...
						            <td align="left">
						            	...
						            	<a href="<%=path %>/download?importTemplateType=carparkFloor">模板下载</a> 	
						            </td>
