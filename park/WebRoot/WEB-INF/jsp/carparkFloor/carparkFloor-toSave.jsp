...
<div class="content">
	...
	<div class="content-right">
		<div class="zsy-right">
			...
			<div class="fbbox">
				<div class="fb-bt">
					<i>停车场楼层${carparkFloor==null?'添加':'修改' }</i>
				</div>
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="<%=path %>/${carparkFloor==null?'carparkFloor_add':'carparkFloor_update' }" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
					        <table width="100%" border="0" class="adduser_tab">
					        <tr>
						            <td align="right" width="110px">停车场： </td>
						            <td align="left" >
						            	<input type="hidden" name="carparkFloor.floorid" value="${carparkFloor.floorid}"/>
						            	<input type="text" class="mes_form1" readonly="readonly" data-rule="required;" id="_carparkname"  name="carparkFloor.carpark.name" value="${carparkFloor.carpark.name}" 
						            	 	/>
							            	<input type="hidden" class="mes_form1"   id="_carparkid" value="${carparkFloor.carpark.carparkid}" name="carparkFloor.carpark.carparkid"/>
						            	 <s:if test="carparkFloor==null">
					            ...
					            <tr>
					            	<td align="right" width="110px">显示默认楼层： </td>
					            	<td>
					            		<s:select list="isdefault" listKey="key" theme="simple" name="carparkFloor.isDefault" listValue="value"></s:select>
					            	</td>
					            </tr>
					        	<tr>
						            <td align="right" width="110px">名称： </td>
						            <td align="left" >
						            	<input type="text" class="mes_form1" id="name" name="carparkFloor.name" value="${carparkFloor.name}"
						            	 	/>
						            </td>
					            </tr>
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="memo" name="carparkFloor.memo" value="${carparkFloor.memo}"
						            	 	/>
						            </td>
					            </tr>
					        </table>
