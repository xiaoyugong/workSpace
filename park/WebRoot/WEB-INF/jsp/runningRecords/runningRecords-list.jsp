...
<div class="content">
	...
	<div class="content-right">
		<div class="zsy-right">
			<div class="z-r-bt">
				<div class="z-r-b-l"><i>位置：</i><a href="###">地锁管理</a> » <a href="###">运行记录</a></div>
				<div class="z-r-b-r"><%=date %></div>
			</div>
			<div class="listbox">
				<div class="listbt">
				    <form action="<%=path %>/runningRecords_list" method="post" id="searchForm" data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
				    	...
				    	<div class="l-b-b">
				    		<ul>
							  <li class="select_box" style="width:120px;">
							    ...
							    <ul class="son_ul" style="width:150px; height: 300px">
							    	<li rel="">请选择...</li>
...
$(document).ready(function(){
	$(".m_runningRecords_l").attr("class","lhover");
	/**
	 * 分页
	 */
