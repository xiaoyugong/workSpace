			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="<%=path %>/carparkEntrancePoint_add" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
					        <table width="100%" border="0" class="adduser_tab">
					        <tr>
						            <td align="right" width="110px">停车场： </td>
						            <td align="left" >
						            	<input type="text" class="mes_form1" value="${carparkEntrancePoint.carpark.name}" readonly="readonly" data-rule="required;" id="_carparkname" 
						            	 	/>
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<select name="carparkEntrancePoint.floorid" id="_floorid">
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<s:select list="#type" listValue="value" theme="simple" listKey="key"></s:select>
						            </td>
					            </tr>
					            <tr>
