			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="department_edit" method="post" id="addForm" autocomplete="off" 
					        ...
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="name" name="department.name" value="${department.name}"
					        	...
					        	<tr>
						            ...
						            <td align="left">
										<textarea name="department.description" data-rule="length[~200]" style="width: 270px; height: 100px" id="description">${department.description}</textarea>
						            </td>
					            </tr>
					        	<tr>
						            <td align="right" width="110px">添加时间： </td>
						            <td align="left">
						            	<input type="text" name="department.createTimeToDate" value="<s:date name="department.createTimeToDate" format="yyyy-MM-dd HH:mm:ss" />" id="createTimeToDate"
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="orderid" name="department.orderid" value="${department.orderid}"
