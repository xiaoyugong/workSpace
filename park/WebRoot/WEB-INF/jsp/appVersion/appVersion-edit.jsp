			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="appVersion_edit" method="post" id="addForm" autocomplete="off" enctype="multipart/form-data"
					        ...
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="versioncode" name="versioncode" 
						            	 	value="${appVersion.id.versioncode}" readonly="readonly"/>
						            </td>
					            </tr>
					        	<tr>
						            <td align="right" width="110px">渠道： </td>
						            <td align="left">
						            	<input type="text" class="mes_form1" 
						            	 	value="${appVersion.appChannel.name}" readonly="readonly"/>
						            	<input type="hidden" name="channelid" value="${appVersion.id.channelid}" />
						            </td>
					            </tr>
					        	<tr>
						            ...
						            <td align="left">
						            	<s:radio list="#{'N':'否','Y':'是'}" name="needUpdate" data-rule="checked" id="needUpdate"
						 					listKey="key" listValue="value" theme="simple" value="appVersion.needUpdate" ></s:radio>
						            </td>
					            </tr>
								<tr>
						            ...
						            <td align="left">
						            	<s:radio list="#{'0':'车主APP','1':'物业APP'}" name="category" data-rule="checked" id="category"
						 					listKey="key" listValue="value" theme="simple" value="appVersion.category" ></s:radio>
						            </td>
					            </tr>
					        	<tr>
					            ...
					            <tr>
						            ...
						            <td align="left">
										<textarea name="content" style="width: 270px; height: 100px" id="content">${appVersion.content}</textarea>
						            </td>
					            </tr>
					        </table>
							<div class="tijiao">
