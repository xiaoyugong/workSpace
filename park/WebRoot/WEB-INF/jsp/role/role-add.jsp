			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="role_add" method="post" id="addForm" autocomplete="off" 
					        ...
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="name" name="role.name" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
										<input type="text" class="mes_form1" id="enname" name="role.enname" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" name="role.createTimeToDate" value="<%=today %>" id="createTimeToDate"
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="orderid" name="role.orderid" value="999"
