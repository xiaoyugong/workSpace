...
<div class="content">
	...
	<div class="content-right">
		<div class="zsy-right">
			...
			<div class="fbbox">
				<div class="fb-bt">
					<i>停车场分类${carparkCategory==null?'添加':'修改' }</i>
				</div>
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="<%=path %>/${carparkCategory==null?'carparkCategory_add':'carparkCategory_update' }" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
					        <table width="100%" border="0" class="adduser_tab">
						            	<input type="hidden" name="carparkCategory.categoryid" value="${carparkCategory.categoryid}"/>
					        	<tr>
						            <td align="right" width="110px">名称： </td>
						            <td align="left" >
						            	<input type="text" class="mes_form1" id="name" name="carparkCategory.name" value="${carparkCategory.name}"
						            	 	/>
						            </td>
					            </tr>
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="memo" name="carparkCategory.memo" value="${carparkCategory.memo}"
						            	 	/>
						            </td>
					            </tr>
					        </table>
