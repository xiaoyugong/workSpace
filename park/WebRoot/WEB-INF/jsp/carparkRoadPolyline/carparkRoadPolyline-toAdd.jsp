			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="<%=path %>/carparkRoadPolyline_add" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
					        ...
					        <tr>
						            ...
						            <td align="left" >
						            	<input type="text" class="mes_form1" readonly="readonly" data-rule="required;" id="_carparkname" 
						            	 	/>
						            	<input type="hidden" class="mes_form1"   id="_carparkid" name="carparkRoadPolyline.carpark.carparkid"/>
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<select name="carparkRoadPolyline.floorid" id="_floorid">
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<input value="${carparkRoadPolyline.color}" data-rule="required,integer;" class="mes_form1" name="carparkRoadPolyline.color"/>
						            </td>
					            </tr>
					            <tr>
					            ...
					            <tr>
						            ...
						            <td align="left">
							            <textarea  rows="7" cols="40" name="carparkRoadPolyline.geometry">${carparkRoadPolyline.geometry}</textarea>
						            </td>
					            </tr>
					        </table>
