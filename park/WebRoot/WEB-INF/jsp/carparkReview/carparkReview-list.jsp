...
<head>
	...
	host = "<%=path%>/";
		function page(page){
			...
			location.href=host+"carparkReview_list?page="+page+"&id="+$("#_carpark").val();
...
<div class="content" >
<input type="hidden" name="id" value="${id}" id="_carpark"/>
	...
	if(ids == 0){
		...
		if(ids.length>0){
			...
			layer.confirm('确定要删除吗？',function(index){
				window.location.href=the_host+"carparkReview_delete?id="+$("#_carpark").val()+"&ids="+ids;
			});
		}else{
