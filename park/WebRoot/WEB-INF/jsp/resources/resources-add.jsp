			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="resources_add" method="post" id="addForm" autocomplete="off" 
					        ...
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="name" name="resources.name" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
										<input type="text" class="mes_form1" id="enname" name="resources.enname" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="target" name="resources.target" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" name="resources.createTimeToDate" value="<%=today %>" id="createTimeToDate"
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="orderid" name="resources.orderid" value="999"
