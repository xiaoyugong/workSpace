			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="<%=path %>/carparkMarkerPoint_add" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
					        ...
					        <tr>
						            ...
						            <td align="left" >
						            	<input type="text" class="mes_form1" readonly="readonly" data-rule="required;" id="_carparkname" 
						            	 	/>
						            	<input type="hidden" class="mes_form1"   id="_carparkid" name="carparkMarkerPoint.carpark.carparkid"/>
					            ...
					            <tr>
					            	...
					            	<td align="left">
					            		<s:select list="carparkMarkerCategorys" theme="simple" listValue="name" listKey="categoryid" name="carparkMarkerPoint.carparkMarkerCategory.categoryid"></s:select>
					            	</td>
					            </tr>
					            <tr>
					            ...
					            <tr>
						            ...
						            <td align="left">
							            <textarea  rows="7" cols="40" name="carparkMarkerPoint.geometry">${carparkMarkerPoint.geometry}</textarea>
						            </td>
					            </tr>
					        </table>
