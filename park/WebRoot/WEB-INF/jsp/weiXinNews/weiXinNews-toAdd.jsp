			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					...
					<form action="<%=path %>/weiXinMaterial_addThumb" method="post" enctype="multipart/form-data"  id="uploadForm" autocomplete="off" 
						...
						<form action="<%=path %>/weiXinNews_add" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
					        <table width="100%" border="0" class="adduser_tab">
					            <tr>
					            	<td align="right" width="110px">缩略图： </td>
						            <td align="left">
						            	<input class="mes_form1" readonly="readonly" type="text" name="news.thumb_media_id" id="thumb" value=""/>
						            </td>
					            </tr>
					            <tr>
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	是:<input  type="radio" checked="checked" value="1" name="news.show_cover_pic"/>
						            	否:<input  type="radio" value="0" name="news.show_cover_pic"/>
