...
var host='<%=path%>';
	function importexcel(){
	 $("#addForm").form('submit',{
		 	url:host+"/carparkNavigationPoint_importExcel",
		 	onSubmit:function(){
			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="carparkNavigationPoint_importExcel" method="post" id="addForm" autocomplete="off" enctype="multipart/form-data"
					        ...
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            ...
						            <td align="left">
						            	...
						            	<a href="<%=path %>/download?importTemplateType=carparkNavigationPoint">模板下载</a>  	 	
						            </td>
