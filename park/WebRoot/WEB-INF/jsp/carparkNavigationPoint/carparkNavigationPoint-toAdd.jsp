			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="<%=path %>/carparkNavigationPoint_add" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
					        ...
					        <tr>
						            ...
						            <td align="left" >
						            	<input type="text" class="mes_form1" readonly="readonly" data-rule="required;" id="_carparkname" 
						            	 	/>
						            	<input type="hidden" class="mes_form1"   id="_carparkid" name="carparkNavigationPoint.carparkid"/>
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<select name="carparkNavigationPoint.startFloorid" class="_floorid" >
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<select name="carparkNavigationPoint.endFloorid" class="_floorid" >
						            		<option>---请先选择一个停车场--</option>
						            	</select>
						            </td>
					            </tr>
