...
var host='<%=path%>';
	function importexcel(){
	 $("#addForm").form('submit',{
		 	url:host+"/carparkFuzhuPolygon_importExcel",
		 	onSubmit:function(){
			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="carparkFuzhuPolygon_importExcel" method="post" id="addForm" autocomplete="off" enctype="multipart/form-data"
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="file" class="mes_form1" id="upload" name="upload" 
						            	 ...
						            	 <a href="<%=path %>/download?importTemplateType=carparkFuzhuPolygon">模板下载</a>  	
						            </td>
