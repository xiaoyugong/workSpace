			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="<%=path %>/carparkFuzhuPolygon_add" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
					        ...
					        <tr>
						            ...
						            <td align="left" >
						            	<input type="text" class="mes_form1" readonly="readonly" data-rule="required;" id="_carparkname" 
						            	 	/>
						            	<input type="hidden" class="mes_form1"   id="_carparkid" name="carparkFuzhuPolygon.carpark.carparkid"/>
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<select name="carparkFuzhuPolygon.floorid" id="_floorid">
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<input value="${carparkFuzhuPolygon.color}" data-rule="required,integer;" class="mes_form1" name="carparkFuzhuPolygon.color"/>
						            </td>
					            </tr>
					            <tr>
					            ...
					            <tr>
						            ...
						            <td align="left">
							            <textarea  rows="7" cols="40" name="carparkFuzhuPolygon.geometry">${carparkFuzhuPolygon.geometry}</textarea>
						            </td>
					            </tr>
					        </table>
