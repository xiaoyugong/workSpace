			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="appChannel_add" method="post" id="addForm" autocomplete="off" 
					        ...
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="name" name="appChannel.name" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="orderid" name="appChannel.orderid" value="999"
					            ...
					            <tr>
						            ...
						            <td align="left">
										<textarea name="appChannel.memo" data-rule="length[~200]" style="width: 270px; height: 100px" id="memo"></textarea>
						            </td>
					            </tr>
					        </table>
							<div class="tijiao">
