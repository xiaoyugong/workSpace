						...
						<td >
							...
							<div class="fb-nr">
								<div class="adduser_form">
									<form action="<%=path %>/users_pointSave" method="post" id="addForm" autocomplete="off" 
								        ...
								        <tr>
								        	...
								        	<tr style="height: 100px;">
								        		...
								        		<td class="jia">
								        			...
								        			<input type="text" name="userPoint.pointvalue" style="width:50px" data-rule="required; integer;" value="${user.credit}"/>
