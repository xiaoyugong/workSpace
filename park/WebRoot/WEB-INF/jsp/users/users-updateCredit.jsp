						...
						<td >
							...
							<div class="fb-nr">
								<div class="adduser_form">
									<form action="<%=path %>/users_creditSave" method="post" id="addForm" autocomplete="off" 
								        ...
								        <tr>
								        	...
								        	<tr style="height: 100px;">
								        		...
								        		<td class="jia">
								        			...
								        			<input type="text" name="userCredit.creditvalue" style="width:50px" data-rule="required; integer;" value="${user.credit}"/>
								        	...
								        	<tr>
									            ...
									            <td align="left">
									            	<input type="text" class="mes_form1" id="name" name="userCredit.description" 
