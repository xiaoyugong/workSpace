...
<div class="content">
	...
	<div class="content-right">
		<div class="zsy-right">
			<div class="z-r-bt">
				<div class="z-r-b-l"><i>位置：</i><a href="###">应用管理</a> » <a href="###">邀请用户</a></div>
				<div class="z-r-b-r"><%=date %></div>
			</div>
			 <form action="<%=path %>/users_invitationList" method="post" id="searchForm">
			...
			<div class="listbox">
				<div class="listbt">
				    <form action="<%=path %>/users_invitationList" method="post" >
				    	<div class="l-b-b">查询邀请用户：
