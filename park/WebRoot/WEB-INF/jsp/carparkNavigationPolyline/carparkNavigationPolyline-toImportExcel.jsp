...
var host='<%=path%>';
	function importexcel(){
	 $("#addForm").form('submit',{
		 	url:host+"/carparkNavigationPolyline_importExcel",
		 	onSubmit:function(){
			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="carparkNavigationPolyline_importExcel" method="post" id="addForm" autocomplete="off" enctype="multipart/form-data"
					        ...
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            ...
						            <td align="left">
						            	...
						            	<a href="<%=path %>/download?importTemplateType=carparkNavigationPolyline">模板下载</a>  	
						            </td>
