			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="<%=path %>/carparkNavigationPolyline_add" method="post" enctype="multipart/form-data"  id="saveForm" autocomplete="off" 
					        ...
					        <tr>
						            ...
						            <td align="left" >
						            	<input type="text" class="mes_form1" readonly="readonly" data-rule="required;" id="_carparkname" 
						            	 	/>
						            	<input type="hidden" class="mes_form1"   id="_carparkid" name="carparkNavigationPolyline.carpark.carparkid"/>
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<select name="carparkNavigationPolyline.floorid" id="_floorid" >
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<input value="${carparkNavigationPolyline.color}" data-rule="integer;" class="mes_form1" name="carparkNavigationPolyline.color"/>
						            </td>
					            </tr>
					            <tr>
					            ...
					            <tr>
						            ...
						            <td align="left">
							            <textarea  rows="7" cols="40" name="carparkNavigationPolyline.geometry">${carparkNavigationPolyline.geometry}</textarea>
						            </td>
					            </tr>
					        </table>
