			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="manager_add" method="post" id="addForm" autocomplete="off" 
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
							<input type="hidden" name="method" value="add"/>
							<input type="hidden" name="resourcesIds" id="resourcesIds"/>
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr><td align="left" colspan="2"><span style="color: red; padding-left: 150px;">${errorMsg}</span></td></tr>
					        	<tr>
						            <td align="right" width="110px">用户名： </td>
						            <td align="left">
						            	<input type="text" class="mes_form1" id="username" name="manager.username" 
						            	 	data-rule="用户名:required; length[~50, true]"/>
						            </td>
					            </tr>
					        	<tr>
						            ...
						            <td align="left">
										<input type="text" class="mes_form1" id="password" name="manager.password" 
						            	 	data-rule="密码:required; length[~100, true]"/>
						            </td>
					            </tr>
					        	<tr>
						            <td align="right" width="110px">姓名： </td>
						            <td align="left">
										<input type="text" class="mes_form1" id="realname" name="manager.realname" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
										<input type="text" class="mes_form1" id="email" name="manager.email" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
										<input type="text" class="mes_form1" id="qq" name="manager.qq" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
										<input type="text" class="mes_form1" id="mobile" name="manager.mobile" 
					        	...
					        	<tr>
						            ...
						            <td align="left">
					            		<s:select theme="simple" list="departments" name="manager.department.departmentid" 
					            			data-rule="部门:required; " listKey="departmentid" listValue="name" headerKey="" headerValue="-请选择-"></s:select>
						            </td>
					            </tr>
					        	<tr>
