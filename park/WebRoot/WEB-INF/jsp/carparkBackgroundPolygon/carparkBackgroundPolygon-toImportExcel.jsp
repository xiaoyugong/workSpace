...
var host='<%=path%>'
	function importexcel(){
	 $("#addForm").form('submit',{
		 	url:host+"/carparkBackgroundPolygon_importExcel",
		 	onSubmit:function(){
			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="carparkBackgroundPolygon_importExcel" method="post" id="addForm" autocomplete="off" enctype="multipart/form-data"
						            ...
						            <td align="left">
						            	<input type="file" class="mes_form1" id="upload" name="upload" 
						            	 	data-rule="Excel文件:required; "/>
						            	 	 <a href="<%=path %>/download?importTemplateType=carparkBackgroundPolygon">模板下载</a>
						            </td>
