			...
			<div class="fbbox">
				...
				<div class="fb-nr">
					<div class="adduser_form">
						<form action="accessBluetooth_edit" method="post" id="addForm" autocomplete="off" 
							data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
							<input type="hidden" name="method" value="edit"/>
							<input type="hidden" name="accessBluetooth.bluetoothid" value="${accessBluetooth.bluetoothid}"/>
							<input type="hidden" name="accessBluetooth.groundlock.groundlockid" value="${accessBluetooth.groundlock.groundlockid}"/>
					       	<input type="hidden" name="accessBluetooth.bluetoothmac" value="${accessBluetooth.bluetoothmac}"/>
					        <table width="100%" border="0" class="adduser_tab">
					        	<tr>
						            <td align="right" width="110px">蓝牙MAC： </td>
						            <td align="left">
						            	<input type="text" class="mes_form1" id="bluetoothmacStr" name="accessBluetooth.bluetoothmacStr" value="${accessBluetooth.bluetoothmacStr}"
					            ...
					            <tr>
						            ...
						            <td align="left">
						            	<s:radio list="#{'0':'车载','1':'非车载'}" name="accessBluetooth.bluetoothtype" data-rule="checked"
											listKey="key" listValue="value" theme="simple" value="accessBluetooth.bluetoothtype"></s:radio>
						            </td>
					            </tr>
					        	<tr>
						            ...
						            <td align="left">
						            	<s:radio list="#{'0':'否','1':'是'}" name="accessBluetooth.bluetoothEnable" data-rule="checked"
											listKey="key" listValue="value" theme="simple" value="accessBluetooth.bluetoothEnable"></s:radio>
						            </td>
					            </tr>
					        	<tr>
						            <td align="right" width="110px">车牌号： </td>
						            <td align="left">
										<input type="text" class="mes_form1" id="carNumber" name="accessBluetooth.carNumber" value="${accessBluetooth.carNumber}"
					        	...
					        	<tr>
						            ...
						            <td align="left">
						            	<input type="text" class="mes_form1" id="telephone" name="accessBluetooth.telephone" value="${accessBluetooth.telephone}"
