...
<script type="text/javascript">
	...
	function offTime() {
		...
		t=3;
		view.innerHTML = "";
		j.innerHTML = "<a href='JavaScript:void(0);' onclick=\"JavaScript:location='<%=path%>/register';return false;\"><span>如果没有跳转，请点击此处</span></a>";
	}
</script>
</head>
...
<table width="100%" style="height: 100%;" cellpadding="0"
	...
	<tr align="left" valign="middle">
		<td style="padding-top: 10px;">
			<center>
				<span style="color:red;font-weight:bold">${msg}</span>,3秒后将自动跳转
