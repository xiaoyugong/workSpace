...
public final class Job extends AbstractJob {
  ...
  public static void main(String[] args) throws Exception {
    if (args.length > 0) {
      ...
      Path output = new Path("hdfs://172.18.200.135:8020/outOFgxy/outputCanopy");
      HadoopUtil.delete(new Configuration(), output);
      run(new Path("hdfs://172.18.200.135:8020/input/kmeansdata"), output, new EuclideanDistanceMeasure(), 80, 55);
    }
  }
