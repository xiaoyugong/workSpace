...
public final class Job extends AbstractJob {
  ...
  public static void main(String[] args) throws Exception {
    if (args.length > 0) {
      ...
      Path output = new Path("hdfs://172.18.200.135:8020/outOFgxy/outputKmeans");
      Configuration conf = new Configuration();
       HadoopUtil.delete(conf, output);
      run(conf, new Path("hdfs://172.18.200.135:8020/input/kmeansdata"), output, new EuclideanDistanceMeasure(), 6, 0.5, 10);
    }
  }
